...
typedef struct
{
  uint8_t w, s, a, d, shift, ctrl, q, e, r, f, g, z, x, c, v, b;
} Key;
...
extern uint16_t flag_q,flag_e,flag_r,flag_f,flag_g,flag_z,flag_x,flag_c,flag_b,flag_ctrl,flag_shift,flag_v;
extern int16_t vx_t,vy_t;
extern uint8_t s1_t,s2_t;
extern uint8_t last_key_q,last_key_e,last_key_r,last_key_f,last_key_g,last_key_z,last_key_x,last_key_c,last_key_b,last_key_ctrl;
