...
void DaMiaoMotor_Class::Drive_Damiao_Motor_MIT(float _pos, float _vel, float _KP, float _KD, float _torq) {
...
void DaMiaoMotor_Class::DaMiaoFeedback(uint8_t* canbuf_receive) {
