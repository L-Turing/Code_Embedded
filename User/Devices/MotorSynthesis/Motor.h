...
public:
  ...
  void Update_Info();
  void SetPitch(float pitch_angle_set);
  void SetYaw(float yaw_angle_set);
  void SetAmmunition(float ammunition_set, motor_control_modes m);
  void SetFriWheel(float fri_rpm);
};
...
public:
  ...
  void DJIFeedback(uint8_t* canbuf_receive);
};
...
public:
  ...
  void DaMiaoFeedback(uint8_t* canbuf_receive);
};
#endif
